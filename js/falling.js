...
LeafScene.prototype.init = function () {
	...
	switch (this.viewport.classList[1]) {
		case "spring":
			this.world.className = "leaf-scene-spring";
			break;
		case "summer":
			this.world.className = "leaf-scene-summer";
			break;
		case "autumn":
			this.world.className = "leaf-scene-autumn";
			break;
		case "winter":
			this.world.className = "leaf-scene-winter";
			break;
		default:
			break;
	}
...
var autumnContainer = document.querySelector(".falling-autumn"),
	leaves = new LeafScene(autumnContainer);
console.log(autumnContainer);
leaves.init();
leaves.render();

var leafContainer = document.querySelector(".falling-winter"),
